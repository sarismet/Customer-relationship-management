    ...
    return (
        <Modal show={this.state.showModal} onHide={this.close.bind(this)}>
          <Modal.Header closeButton>
            <Modal.Title>Raporlama için seçenekleri işaretleyiniz.</Modal.Title>
          </Modal.Header>
          <Modal.Body>
  ...
  render() {
    ...
    return (
        <div className="ReportFilter">
            <Button bsStyle="primary" className="filter-background" bsSize="xsmall" onClick={this.open.bind(this)}>
